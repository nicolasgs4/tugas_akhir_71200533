...
export function Create({ email, username }) {
  ...
  const handleDelete = async (formId) => {
    try {
      const response = await fetch("/create/" + formId, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  return (
    <div className="">
      <div className="justify-start items-start gap-14 px-4 py-6 inline-flex flex-wrap">
        <button
          className="w-[216px] h-[270px] rounded-lg shadow flex-col just  ify-start items-start inline-flex"
          onClick={handleAdd}
        >
          <div className="w-[216px] h-[166px] rounded-t-lg bg-zinc-300 relative">
            ...
            >
              ...
              <g clipPath="url(#clip0_453_3200)">
                <path
                  d="M30 60C13.4306 60 0 46.5694 0 30C0 13.4306 13.4306 0 30 0C46.5694 0 60 13.4306 60 30C60 37.9565 56.8393 45.5871 51.2132 51.2132C45.5871 56.8393 37.9565 60 30 60ZM30 3.75C15.5025 3.75 3.75 15.5025 3.75 30C3.75 44.4975 15.5025 56.25 30 56.25C44.4975 56.25 56.25 44.4975 56.25 30C56.25 23.0381 53.4844 16.3613 48.5616 11.4384C43.6387 6.51562 36.9619 3.75 30 3.75Z"
                  fill="black"
                />
                <path
                  d="M43.125 28.125H31.875V16.875H28.125V28.125H16.875V31.875H28.125V43.125H31.875V31.875H43.125V28.125Z"
                  fill="black"
                />
              </g>
              <defs>
        ...
        {catalog.map((item, index) => (
          <div
            key={"catalog" + index}
            className="w-[216px] rounded-lg shadow flex-col justify-start items-start inline-flex relative"
          >
            <Popup
              trigger={
            ...
            >
              <div className="p-1 bg-white rounded-xl flex-col justify-start items-start gap-1 absolute border-b-2">
                ...
                >
                  <div className="w-6 h-6 relative">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M6.60156 11.397C6.60156 8.671 6.60156 7.308 7.44556 6.461C8.28856 5.614 9.64556 5.614 12.3616 5.614H15.2416C17.9566 5.614 19.3146 5.614 20.1586 6.461C21.0016 7.308 21.0016 8.671 21.0016 11.397V16.217C21.0016 18.943 21.0016 20.306 20.1586 21.153C19.3146 22 17.9566 22 15.2416 22H12.3616C9.64656 22 8.28856 22 7.44556 21.153C6.60156 20.306 6.60156 18.943 6.60156 16.217V11.397Z"
                        fill="black"
                      />
                    </svg>
                  </div>
                  <div className="text-black text-2xl font-normal font-['Segoe UI']">
                    Duplicate
                  </div>
                </button>
                <button
                  className="w-[126px] justify-start items-center gap-0.5 inline-flex"
                ...
                >
                  ...
                  <div className="text-[#FF4853] text-2xl font-normal font-['Segoe UI']">
                    Delete
                  </div>
                </button>
                <Popup
                ...
                >
                  <div className="w-[600px] h-[276px]  relative">
                    ...
                    <div className="left-[19px] top-[77px] absolute text-stone-900 text-2xl font-normal font-['Segoe UI']">
                    ...
                    <div className="w-[120px] h-[60px] left-[375px] top-[174px] absolute">
                      ...
                      <button
                        onClick={() => {
                          formId.current = item.form_id;
                          handleDelete(item.form_id);
                        }}
                      >
                        <div className="left-[11px] top-[16px] absolute text-center text-white text-2xl font-normal font-['Cabin']">
                          Ya, Hapus
                        </div>
                      </button>
                    </div>
                    <div className="w-[120px] h-[60px] left-[105px] top-[174px] absolute">
                      ...
                      <button onClick={closeModal}>
                        <div className="left-[17px] top-[16px] absolute text-center text-neutral-800 text-2xl font-normal font-['Cabin']">
                          Batalkan
                        </div>
                      </button>
                    </div>
            ...
            <div
              onClick={() => {
                formId.current = item.form_id;
                navigate("/form/" + item.form_id + "/edit");
              }}
            >
  ...
  {/* Form Title */}
                <div className="self-stretch text-center text-zinc-900 text-lg font-semibold font-['Inter'] leading-normal whitespace-normal">
                  {item.form_title ? item.form_title : `Belum Ada Judul`}
                </div>
                ...
                <div className="w-full justify-start items-center gap-2 inline-flex">
                  ...
                  >
                    ...
                    <path
                      d="M4 9H6V11H4V9ZM16 2H15V0H13V2H5V0H3V2H2C0.89 2 0.00999999 2.9 0.00999999 4L0 18C0 18.5304 0.210714 19.0391 0.585786 19.4142C0.960859 19.7893 1.46957 20 2 20H16C17.1 20 18 19.1 18 18V4C18 2.9 17.1 2 16 2ZM16 18H2V8H16V18ZM16 6H2V4H16V6ZM12 9H14V11H12V9ZM8 9H10V11H8V9Z"
                      fill="black"
                    />
                  </svg>
                  <div className="text-center text-black text-base font-normal font-['Inter'] leading-normal">
                    {format(item.date_of_creation, "dd MMMM yyyy", { locale: id })}
                  </div>
                </div>
              </div>
            </div>
