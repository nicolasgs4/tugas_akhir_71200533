    ...
    <div>
      <div className="justify-start items-start gap-14 px-4 py-6 inline-flex flex-wrap">
        {catalog.map((item, index) => (
          <button
            key={"catalog" + index}
            className="w-[216px] rounded-lg shadow flex-col justify-start items-start inline-flex"
            onClick={(e) => navigate("/form/" + item.form_id + "/analysis")}
          >
            <div className="w-[216px] h-[166px] rounded-t-lg bg-zinc-300" />
            <div className="px-3 py-2 rounded-b-lg bg-white flex-col w-[200px] overflow-hidden justify-start items-start gap-2 flex">
            {/* Title with dynamic height and wrapping */}
            <div className="self-stretch text-center text-zinc-900 text-lg font-semibold font-['Inter'] leading-normal whitespace-normal text-ellipsis overflow-hidden">
