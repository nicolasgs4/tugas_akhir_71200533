                                            ...
                                            <ul key={index} className='list-none space-y-4 overflow-y-scroll max-h-[300px]'>
                                                {
                                                    element
                                                        ...
                                                        .map((item, index ) => (
                                                        <li key={index} tabIndex="0" className="h-wrap p-2.5 bg-[#fcfcfc] rounded-[10px] border border-[#3bc0ed] justify-start items-start gap-2.5 flex">
                                                            <div className="text-black text-base font-normal font-['Montserrat']">{index + 1 + ". " + item}</div>
                                                        </li>
                                                    ))
                                                }
                                            </ul>
